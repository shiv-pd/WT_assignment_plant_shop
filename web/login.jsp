<%-- 
    Document   : login
    Created on : Apr 15, 2025, 11:04:42 AM
    Author     : LENOVO
--%>
...
<html>
    ...
    <body class="h-[100vh] flex items-center justify-center bg-image">
        <form action="login" method="post" class="h-[63vh] border-2 bg-white border-gray-200 sm:w-[28rem] rounded-xl p-12 min-w-[22rem] flex flex-col gap-2  ">
             
            <h1 class="text-3xl font-semibold self-center mb-4" >Login</h1>
            ...
            <p class="self-center mt-[-1rem]">Don't have an account? &nbsp; <a href="registration.jsp" class=" text-blue-600 underline hover:text-blue-800 visited:text-purple-600 ">Register here</a> </p>
